...
const totalUnfundedText = `We currently have ${totalUnfunded} unfunded ${totalUnfunded === 1 ? 'game' : 'games'} out of ${GAMES_JSON.length} total. ${
    totalUnfunded === 0 ? 'All our games have met their funding goals!' : 'We need your help to fund these amazing games!'}`;

// create a new DOM element containing the template string and append it to the description container
const descriptionElement = document.createElement("p");
descriptionElement.innerText = totalUnfundedText;
...
const [topGame, runnerUpGame, ...remaining] = sortedGames;
